...
namespace iSpyApplication.Controls
{
    public sealed partial class PiPSelector : Panel
    {
            ...
            set
            {
                ...
                foreach (var s in cfg)
                {
                    if (s != "")
                    {
                        ...
                        if (int.TryParse(t[0], out int cid) && int.TryParse(t[1], out int x) && int.TryParse(t[2], out int y) && int.TryParse(t[3], out int w) &&
        ...
        private void OnBoundsChanged() => BoundsChanged?.Invoke(this, EventArgs.Empty);
    }
}