...
namespace iSpyApplication
{
    public partial class GridView : Form
    {
        ...
        private readonly PersistWindowState _mWindowState;
        ...
        private void OnTop() => TopMost = alwaysOnTopToolStripMenuItem.Checked;

        private void Edit() => _gv.MainClass.EditGridView(_layout.name, this);
        ...
        private void fullScreenToolStripMenuItem_Click(object sender, EventArgs e) => MaxMin();

        private void alwaysOnTopToolStripMenuItem_Click(object sender, EventArgs e) => OnTop();

        private void closeGridViewToolStripMenuItem_Click(object sender, EventArgs e) => Close();
        ...
        private void switchFillModeAltFToolStripMenuItem_Click(object sender, EventArgs e) => _gv.Cg.Fill = !_gv.Cg.Fill;
        ...
        private void quickSelectToolStripMenuItem_Click(object sender, EventArgs e)
        {
            using (var so = new SelectObjects())
            {
                ...
                if (so.DialogResult == DialogResult.OK)
                {
                    ...
                    {
                        int oid = -1, otid = -1;
                        if (o is objectsCamera k)
                        {
                            oid = k.id;
                            otid = 2;
                        }
                        if (o is objectsMicrophone j)
                        {
                            oid = j.id;
                            otid = 1;
                        }
                        if (o is objectsFloorplan m)
                        {
                            oid = m.id;
                            otid = 3;
                        }
        ...
        private void quickSelectToolStripMenuItem_DropDownOpening(object sender, EventArgs e) => quickSelectToolStripMenuItem.Visible = _gv.Cg.ModeIndex == 0;
